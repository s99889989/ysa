...
const handleToggleTheme = () => {
  ...
  localStorage.setItem("dark_mode", dark.value+"");
};
onMounted(()=>{
...
<template>
  <div
      class="them h-8 w-8 cursor-pointer select-none rounded bg-slate-100 text-gray-500 shadow dark:bg-slate-700 dark:text-gray-400"

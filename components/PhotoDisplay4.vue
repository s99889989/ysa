  ...
  <div class="dark:bg-black p-4 bg-white min-h-screen container-top">
    ...
    <nav aria-label="Page navigation example" class="pt-2 items-center flex justify-center">
      <ul class="flex items-center -space-x-px h-8 text-sm">
        ...
        <li>
          <a href="#" aria-current="page" class="z-10 flex items-center justify-center px-3 h-8 leading-tight text-blue-600 border border-blue-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700dark:text-white">3</a>
        </li>
        <li>
